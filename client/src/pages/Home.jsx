        ...
        <section className="space-y-16">
          ...
          <div className="flex flex-col md:flex-row items-end justify-between gap-6">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl lg:text-5xl font-black text-white">What students say</h2>
...
function ReviewCard({ review }) {
  return (
    <div className="glass-card p-8 rounded-[2rem] border border-white/5 hover:border-brand-gold/20 transition-all duration-300 hover:-translate-y-1 space-y-5 flex flex-col">
      {/* Quote icon + stars */}
